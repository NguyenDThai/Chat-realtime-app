      ...
      <div className="relative bg-white/10 p-8 rounded-3xl shadow-2xl w-full max-w-md border border-white/20 hover:border-white/40 transition-all duration-500 hover:shadow-[0_8px_32px_rgba(0,0,0,0.4)]">
        ...
        <form className="space-y-5" onSubmit={onSubmit}>
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            <a
              href="#"
              className="text-[var(--color-theme-primary-dark)] hover:text-white hover:underline font-medium transition-colors"
            >
              Quên mật khẩu?
            </a>
          </div>
          ...
          <button
            type="submit"
            className="relative group w-full bg-gradient-to-r from-[var(--color-theme-primary)] to-[var(--color-theme-primary-hover)] text-white py-3 rounded-xl font-semibold hover:opacity-95 transform hover:scale-[1.02] transition-all duration-200 shadow-lg shadow-[var(--color-theme-primary)]/30 hover:shadow-xl hover:shadow-[var(--color-theme-primary)]/40 overflow-hidden cursor-pointer"
          >
