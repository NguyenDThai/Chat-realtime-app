import { Eye, Palette, Sun } from "lucide-react";
import { useState } from "react";

const ActiveTabSetting = () => {
  const [selectedColor, setSelectedColor] = useState("green");

  // Mảng chứa cấu hình các màu sắc tương ứng với ảnh thiết kế
  const colors = [
    {
      id: "green",
      name: "Xanh lá",
  ...
  return (
    <div className="w-[625px] mx-auto mt-6">
      ...
      <div className="flex justify-between">
        <h3 className="font-semibold text-lg text-white">Giao diện cấu hình</h3>
        <button className="py-1.5 px-3 bg-green-600 text-white rounded-[16px] text-sm cursor-pointer">
          Lưu
        </button>
      </div>
      {/* body */}
      <div className="mt-4 flex flex-col gap-2">
        ...
        <div className="py-4 px-[18px] border border-gray-400 rounded-[10px]">
          <div className="flex items-center gap-2">
            <Eye className="w-4 h-4 text-white" />
            <span className="text-base text-white font-normal">Giao diện</span>
          </div>
          <div className="flex items-center gap-3 mt-3">
            <button className="w-full flex items-center justify-center bg-green-400/20 gap-2 py-3 rounded-[8px] border-2 border-green-700 cursor-pointer">
              <Sun className="w-4 h-4 text-white" />
              <span className="text-base text-white font-normal">Sáng</span>
            </button>
            <button className="w-full flex items-center justify-center gap-2 bg-green-400/20 py-3 rounded-[8px] border-2 border-green-700 cursor-pointer">
              <Sun className="w-4 h-4 text-white" />
              <span className="text-base text-white font-normal">Tối</span>
            </button>
          </div>
        </div>
        {/* color theme */}
        <div className="py-4 px-[18px] border border-gray-400 rounded-[10px]">
          <div className="flex items-center gap-2">
            ...
            <span className="text-base text-white font-normal">Màu chủ đề</span>
          </div>
