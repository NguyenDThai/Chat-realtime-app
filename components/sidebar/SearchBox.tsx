    ...
    <>
      <div className="relative">
        <input
          ...
          className="relative w-full px-4 py-2 pl-10 mb-4 bg-slate-100 dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 rounded-xl focus:outline-none focus:border-[var(--color-theme-primary)] focus:ring-2 focus:ring-[var(--color-theme-primary)]/50 transition-all duration-200 text-slate-800 dark:text-white placeholder-slate-400 dark:placeholder-zinc-500 text-sm"
        />
        {searchTerm && (
          <X
